...
import rlu.benchmarks.jmh_generated.RluFineBSTBenchmark_ThreadState_jmhType;
public final class RluFineBSTBenchmark_g8for60_jmhTest {
    ...
    public BenchmarkTaskResult g8for60_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                ...
                l_rlufinebstbenchmark0_G.read8With60PercentContains(l_globalstate1_G, l_threadstate2_0);
            ...
            read8With60PercentContains_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_globalstate1_G, l_threadstate2_0, l_rlufinebstbenchmark0_G);
        ...
        if (threadParams.getSubgroupIndex() == 1) {
            ...
            while (control.warmupShouldWait) {
                ...
                l_rlufinebstbenchmark0_G.write8With60PercentContains(l_globalstate1_G, l_threadstate2_1);
                if (RluFineBSTBenchmark_GlobalState_jmhType.tearInvocationMutexUpdater.compareAndSet(l_globalstate1_G, 0, 1)) {
                    try {
                        if (control.isFailing) throw new FailureAssistException();
                        if (l_globalstate1_G.readyInvocation) {
            ...
            notifyControl.startMeasurement = true;
            write8With60PercentContains_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_globalstate1_G, l_threadstate2_1, l_rlufinebstbenchmark0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult g8for60_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            read8With60PercentContains_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_globalstate1_G, l_threadstate2_0, l_rlufinebstbenchmark0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
        ...
        if (threadParams.getSubgroupIndex() == 1) {
            ...
            notifyControl.startMeasurement = true;
            write8With60PercentContains_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_globalstate1_G, l_threadstate2_1, l_rlufinebstbenchmark0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult g8for60_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            read8With60PercentContains_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_globalstate1_G, l_threadstate2_0, l_rlufinebstbenchmark0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
        ...
        if (threadParams.getSubgroupIndex() == 1) {
            ...
            int opsPerInv = benchmarkParams.getOpsPerInvocation();
            SampleBuffer buffer = new SampleBuffer();
            write8With60PercentContains_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_globalstate1_G, l_threadstate2_1, l_rlufinebstbenchmark0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult g8for60_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            read8With60PercentContains_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_globalstate1_G, l_threadstate2_0, l_rlufinebstbenchmark0_G);
            control.preTearDown();
            if (RluFineBSTBenchmark_GlobalState_jmhType.tearIterationMutexUpdater.compareAndSet(l_globalstate1_G, 0, 1)) {
                try {
                    if (control.isFailing) throw new FailureAssistException();
        ...
        if (threadParams.getSubgroupIndex() == 1) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            write8With60PercentContains_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_globalstate1_G, l_threadstate2_1, l_rlufinebstbenchmark0_G);
            control.preTearDown();
            if (RluFineBSTBenchmark_GlobalState_jmhType.tearIterationMutexUpdater.compareAndSet(l_globalstate1_G, 0, 1)) {
                try {
                    if (control.isFailing) throw new FailureAssistException();
