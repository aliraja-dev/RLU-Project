...
import rlu.benchmarks.jmh_generated.RluSetBenchmark_GlobalState_jmhType;
...
public final class RluSetBenchmark_g16For20_jmhTest {
    ...
    public BenchmarkTaskResult g16For20_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RluSetBenchmark_ThreadState_jmhType l_threadstate2_0 = _jmh_tryInit_f_threadstate2_0(control);
            ...
            while (control.warmupShouldWait) {
                ...
                l_rlusetbenchmark0_G.read16With20PercentContains(l_globalstate1_G, l_threadstate2_0);
            ...
            read16With20PercentContains_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_globalstate1_G, l_threadstate2_0, l_rlusetbenchmark0_G);
        ...
        if (threadParams.getSubgroupIndex() == 1) {
            RawResults res = new RawResults();
            RluSetBenchmark_jmhType l_rlusetbenchmark0_G = _jmh_tryInit_f_rlusetbenchmark0_G(control);
            RluSetBenchmark_ThreadState_jmhType l_threadstate2_1 = _jmh_tryInit_f_threadstate2_1(control);
            RluSetBenchmark_GlobalState_jmhType l_globalstate1_G = _jmh_tryInit_f_globalstate1_G(control);
    ...
    public BenchmarkTaskResult g16For20_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            read16With20PercentContains_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_globalstate1_G, l_threadstate2_0, l_rlusetbenchmark0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult g16For20_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            read16With20PercentContains_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_globalstate1_G, l_threadstate2_0, l_rlusetbenchmark0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void read16With20PercentContains_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, RluSetBenchmark_GlobalState_jmhType l_globalstate1_G, RluSetBenchmark_ThreadState_jmhType l_threadstate2_0, RluSetBenchmark_jmhType l_rlusetbenchmark0_G) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult g16For20_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            read16With20PercentContains_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_globalstate1_G, l_threadstate2_0, l_rlusetbenchmark0_G);
            control.preTearDown();
            if (RluSetBenchmark_GlobalState_jmhType.tearIterationMutexUpdater.compareAndSet(l_globalstate1_G, 0, 1)) {
                try {
                    if (control.isFailing) throw new FailureAssistException();
    ...
    public static void read16With20PercentContains_ss_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, int batchSize, RluSetBenchmark_GlobalState_jmhType l_globalstate1_G, RluSetBenchmark_ThreadState_jmhType l_threadstate2_0, RluSetBenchmark_jmhType l_rlusetbenchmark0_G) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    RluSetBenchmark_ThreadState_jmhType f_threadstate2_0;
    
    RluSetBenchmark_ThreadState_jmhType _jmh_tryInit_f_threadstate2_0(InfraControl control) throws Throwable {
        if (control.isFailing) throw new FailureAssistException();
        RluSetBenchmark_ThreadState_jmhType val = f_threadstate2_0;
        if (val == null) {
    ...
    RluSetBenchmark_ThreadState_jmhType f_threadstate2_1;
    
    RluSetBenchmark_ThreadState_jmhType _jmh_tryInit_f_threadstate2_1(InfraControl control) throws Throwable {
        if (control.isFailing) throw new FailureAssistException();
        RluSetBenchmark_ThreadState_jmhType val = f_threadstate2_1;
        if (val == null) {
            val = new RluSetBenchmark_ThreadState_jmhType();
    ...
    static java.util.Map<Integer, RluSetBenchmark_GlobalState_jmhType> f_globalstate1_G_map = java.util.Collections.synchronizedMap(new java.util.HashMap<Integer, RluSetBenchmark_GlobalState_jmhType>());
    
    RluSetBenchmark_GlobalState_jmhType _jmh_tryInit_f_globalstate1_G(InfraControl control) throws Throwable {
        int groupIdx = threadParams.getGroupIndex();
        RluSetBenchmark_GlobalState_jmhType val = f_globalstate1_G_map.get(groupIdx);
        if (val != null) {
            return val;
        }
        synchronized(this.getClass()) {
            ...
            val = new RluSetBenchmark_GlobalState_jmhType();
            val.readyTrial = true;
